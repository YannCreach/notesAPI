...
import { Cart, List, Tag } from "../../models/index.js";
          ...
          if (entity === "list") {
            ...
            if (existingTag) {
              return response
                .status(400)
                .json({
                  error: `[${assoc}][${assocId}] est déjà associé à [${entity}][${entityId}]`,
                });
            }
            ...
            if (tag && list) {
              ...
              await list.save();
              res.json({
                status: `[${assoc}][${assocId}] correctement associé à [${entity}][${entityId}]`,
              });
            } else {
              res
                .status(404)
                .json({
                  message: `[${assoc}][${assocId}] or [${entity}][${entityId}] not found`,
                });
            }
          } else if (entity === "cart") {
...
export default tagAssocController;
